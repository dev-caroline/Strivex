  ...
  return (
    <div className='px-4'>
      ...
      <div className='flex justify-between mt-5 border p-1 gap-3'>
        <h5 className='text-yellow-800 p-2 rounded-md text-sm'> 💡 You have a new access request </h5>
      ...
      <div className='mt-18'>
        ...
        <div className='flex gap-3 mt-2'>
          <div className='bg-gray-100 rounded-xl col-8 p-4 fs-5 mt-4 flex-wrap flex overflow-hidden ' style={{ maxHeight: '30vh' }}>
          ...
          <div className='bg-gray-500 rounded-xl col-4 mt-4 text-white p-4' style={{ height: '30vh' }}>
            User Statistics
          </div>
        </div>
      </div>
