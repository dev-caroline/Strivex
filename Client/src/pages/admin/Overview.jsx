  ...
  return (
    <div className='px-4'>
      ...
      <div className='flex justify-between mt-5 border p-1 gap-3'>
        <h5 className='text-yellow-800 p-2 rounded-md text-sm'> 💡 You have no new access request </h5>
        <button className=' text-white border px-13 rounded fw-bold' style={{ backgroundColor: '#A43C3C' }}>Review</button>
      </div>

      <div className='mt-3'>
        <h3 className='mt-2'>Recent Activities</h3>
        <div className='flex gap-3'>
          <div className='bg-gray-100 rounded-xl col-8 p-4 fs-5 mt-4 flex-wrap flex overflow-hidden ' style={{ maxHeight: '40vh' }}>
          ...
          <div className='bg-gray-500 rounded-xl col-4 mt-3 text-white p-4' style={{ height: '40vh' }}>
            User Statistics
          </div>
        </div>
      </div>
